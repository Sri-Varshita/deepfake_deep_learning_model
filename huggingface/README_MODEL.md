...
- **Compact Input**: 128×128 pixel input for efficient processing
...
if fake_prob > real_prob:
    print(f"🚨 FAKE (AI-Generated) - Confidence: {fake_prob*100:.2f}%")
else:
    print(f"✅ AUTHENTIC (Genuine) - Confidence: {real_prob*100:.2f}%")
```
...
⚡ Powered by TensorFlow | 🤗 Hosted on Hugging Face | 🎯 Application: Digital Forensics
